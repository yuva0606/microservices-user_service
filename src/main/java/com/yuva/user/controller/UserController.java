...
public class UserController {
    ...
    public ResponseEntity<?> updateRoleHandler(HttpServletRequest httpServletRequest){
        return ResponseEntity.status(HttpStatus.OK).body(userService.updateRole(httpServletRequest));
    }
}
